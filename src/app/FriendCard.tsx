  ...
  return (
    ...
    <div className="flex">
        <div className="flex">
                ...
                <h3 className="text-lg font-semibold text-gray-800 text-center">Photo</h3>
                ...
                </div>
            {
              delta > 0 ? (
                <div className="flex-row-reverse">
                  <div className="bg-red-200 rounded-lg p-1 pl-4 pr-4 text-lg font-bold text-gray-900 text-center mr-1">₹1,234 <div>
                ...
                <div className="flex-row-reverse">
                  <div className="bg-green-200 rounded-lg p-1 pl-4 pr-4 text-lg font-bold text-gray-900 text-center mr-1">₹1,234 <div>
                  <Button className="align-middle">Settle</Button>
                  </div>
                </div>
              </div>
