...
const FriendCard = () => {
  return (
    ...
    <div className="flex-row-reverse">
        <div className="bg-red-200 rounded-lg p-1 pl-4 pr-4 text-lg font-bold text-gray-900 text-center mr-1">₹1,234 <div><Button className="align-middle">Settle</Button></div></div>
